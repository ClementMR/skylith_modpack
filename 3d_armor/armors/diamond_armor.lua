...
armor:register_armor("3d_armor:helmet_diamond", {
    ...
    groups = {armor_head=1, armor_heal=1, armor_use=200},
...
armor:register_armor("3d_armor:chestplate_diamond", {
    ...
    groups = {armor_torso=1, armor_heal=1, armor_use=200},
...
armor:register_armor("3d_armor:leggings_diamond", {
    ...
    groups = {armor_legs=1, armor_heal=1, armor_use=200},
    armor_groups = {fleshy=20},
    damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
})
--- Diamond Boots
...
armor:register_armor("3d_armor:boots_diamond", {
    ...
    groups = {armor_feet=1, armor_heal=1, armor_use=200, armor_feather = 6},
    armor_groups = {fleshy=15},
    damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
})
--- Diamond Shield
...
armor:register_armor(":shields:shield_diamond", {
    ...
    groups = {armor_shield=1, armor_heal=1, armor_use=200},
    armor_groups = {fleshy=15},
    damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
