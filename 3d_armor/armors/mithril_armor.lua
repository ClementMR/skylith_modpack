...
armor:register_armor("3d_armor:helmet_mithril", {
    ...
    groups = {armor_head=1, armor_heal=4, armor_use=100},
...
armor:register_armor("3d_armor:chestplate_mithril", {
    ...
    groups = {armor_torso=1, armor_heal=4, armor_use=100},
...
armor:register_armor("3d_armor:leggings_mithril", {
    ...
    groups = {armor_legs=1, armor_heal=4, armor_use=100},
    armor_groups = {fleshy=19},
    damage_groups = {cracky=2, snappy=1, level=3},
})
...
armor:register_armor("3d_armor:boots_mithril", {
    ...
    groups = {armor_feet=1, armor_heal=4, armor_use=100, armor_feather = 6},
    armor_groups = {fleshy=14},
    damage_groups = {cracky=2, snappy=1, level=3},
})
...
armor:register_armor(":shields:shield_mithril", {
    ...
    groups = {armor_shield=1, armor_heal=4, armor_use=100},
    armor_groups = {fleshy=14},
    damage_groups = {cracky=2, snappy=1, level=3},
