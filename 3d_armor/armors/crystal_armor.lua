...
armor:register_armor("3d_armor:helmet_crystal", {
    ...
    groups = {armor_head=1, armor_heal=5, armor_use=100, armor_fire=1},
...
armor:register_armor("3d_armor:chestplate_crystal", {
    ...
    groups = {armor_torso=1, armor_heal=5, armor_use=100, armor_fire=1},
...
armor:register_armor("3d_armor:leggings_crystal", {
    ...
    groups = {armor_legs=1, armor_heal=5, armor_use=100, armor_fire=1},
    armor_groups = {fleshy=20},
    damage_groups = {cracky=2, snappy=1, level=3},
})
...
armor:register_armor("3d_armor:boots_crystal", {
    ...
    groups = {armor_feet=1, armor_heal=5, armor_use=100, physics_speed=1,
            physics_jump=0.5, armor_fire=1, armor_feather = 7},
    armor_groups = {fleshy=15},
    damage_groups = {cracky=2, snappy=1, level=3},
})
...
armor:register_armor(":shields:shield_crystal", {
    ...
    groups = {armor_shield=1, armor_heal=5, armor_use=100, armor_fire=1},
    armor_groups = {fleshy=15},
    damage_groups = {cracky=2, snappy=1, level=3},
