...
armor.get_armor_formspec = function(self, name)
    ...
    for a = 1, #armor.elements do
        if player:get_inventory():get_stack("armor", a):is_empty() then
            armor_slot_imgs = armor_slot_imgs ..
                "image[0,"..(a - 1)..";1,1;3d_armor_stand_"..armor.elements[a]..".png]"
        end
    end

    local form = "list[detached:"..name.."_armor;armor;0,0;1,5;]" ..
        default.gui_slots..
        armor_slot_imgs
